...
def write_launchers(output: Path) -> None:
    ...
    (output / "START HERE.txt").write_text(
        ...
        "F3 = performance charts, filtered logs and live population controls.\n"
        "F11 = fullscreen; the Performance panel also offers UI scale and display modes.\n"
        "Apply live changes the current population while the day continues.\n\n"
